---
description: USE WHEN memory retrieval returns outdated or contradictory results, or when cleaning up snapshots, running governance, or resolving contradictions
globs:
alwaysApply: false
---
