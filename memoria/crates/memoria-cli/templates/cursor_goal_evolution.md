---
description: USE WHEN working on multi-step tasks, tracking goals, plans, progress, lessons across conversations
globs:
alwaysApply: true
---
...
Track goals, plans, progress, lessons, and user feedback across conversations. Integrates with Composer and Agent mode.
